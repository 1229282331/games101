...
class Bounds3
{
  public:
    ...
    Vector3f Diagonal() const { return pMax - pMin; }   /*获取盒子的长宽高*/
    int maxExtent() const   /*判断最长轴*/
    {
        Vector3f d = Diagonal();
        if (d.x > d.y && d.x > d.z)
            return 0;
    ...
    Vector3f Centroid() { return 0.5 * pMin + 0.5 * pMax; } /*计算盒子（长方体形心）*/
    Bounds3 Intersect(const Bounds3& b) /*求两个盒子交集*/
    {
    ...
    bool Overlaps(const Bounds3& b1, const Bounds3& b2) /*判断两个盒子是否相交*/
    {
    ...
    bool Inside(const Vector3f& p, const Bounds3& b)    /*判断点是否在长方体内*/
    {
